...
.rentify-popup .leaflet-popup-tip        { background: #0F1B2D; }
.rentify-popup .leaflet-popup-close-button {
    color: #F59E0B !important; font-size: 18px !important;
    top: 8px !important; right: 8px !important;
}
.map-popup-img   { width:100%; height:120px; object-fit:cover; }
.map-popup-body  { padding: 12px 14px; }
.map-popup-name  { font-size:14px; font-weight:700; color:#F59E0B; margin-bottom:4px; }
.map-popup-cat   { font-size:12px; color:#94a3b8; margin-bottom:8px; }
.map-popup-price { font-size:15px; font-weight:700; color:#fff; margin-bottom:10px; }
.map-popup-price span { color:#F59E0B; }
.map-popup-btn {
    display:block; background:#F59E0B; color:#0F1B2D !important;
...
.custom-marker i { transform: rotate(45deg); color: #0F1B2D; font-size: 13px; }
...
<div style="max-width:1280px;margin:16px auto 0;padding:0 32px;">
    ...
    <button id="btnToggleMap"
        class="btn fw-bold btn-map-toggle"
        onclick="toggleMap()">
        ...
        <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
            ...
            <div class="card-footer" style="background:#0F1B2D;border-top:1px solid #1a2f4a;">
                <div class="d-flex flex-wrap gap-3 small text-muted">
                    ...
                    <span><i class="fas fa-mouse-pointer me-1 text-white-50"></i>Cliquez sur un marqueur pour voir les détails</span>
                </div>
            </div>
...
/* ══════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════ */
let filters = {
    type: '', ville: '', maxPrice: 5000,
    disponible: false, search: '', sort: 'created_at'
};
let debounceTimer;
const emojis = {
    Excavatrice:'🏗', Camion:'🚛', Grue:'🏙',
    Manitou:'🔧', Compacteur:'⚙️', Bulldozer:'🚧', Niveleuse:'🚜'
};
        ...
        <div class="mc-card" style="animation-delay:${delay}ms"
            ...
            <div class="mc-card-body">
                ...
                <div class="mc-card-loc">
                    <i class="fas fa-map-marker-alt"></i>${m.location || '—'}
                </div>
